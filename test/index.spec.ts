...
describe("Encryption", () => {
  it("Should pass standard test suite", () => {
    ...
    expect(shacrypt.verify(data[1], data[2])).to.be.true;
  });
  ...
  it("Should throw an exception when used with any other crypto than sha256 or sha512", () => {
    ...
    expect(() => shacrypt.encrypt(data[1], data[0])).to.throw("Only sha256 and sha512 is supported by this library");
    expect(() => shacrypt.verify(data[1], data[2])).to.throw("Only sha256 and sha512 is supported by this library");
  });
  ...
  it("Should throw an exception when salt contains invalid characters", () => {
    ...
    expect(() => shacrypt.encrypt(data[1], data[0])).to.throw("Salt contains invalid characters");
    expect(() => shacrypt.verify(data[1], data[2])).to.throw("Salt contains invalid characters");
  });
  ...
  it("Should throw an exception when the salt string contains too many '$'-characters", () => {
    ...
    expect(() => shacrypt.encrypt(data[1], data[0])).to.throw("Invalid salt string");
    expect(() => shacrypt.verify(data[1], data[2])).to.throw("Invalid salt string");
  });
